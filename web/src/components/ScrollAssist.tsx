...
export function ScrollAssist({ scrollRef }: Props) {
  ...
  return (
    <div className="fixed right-3 bottom-20 z-[60] flex flex-col gap-2 md:right-5 md:bottom-8 pointer-events-auto">
      <button
        type="button"
